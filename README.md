...
```bash
# 前提: Python 3.11, CUDA 12.x 対応 GPU
...
| ファイル | 用途 | 入手元 |
|----------|------|--------|
| `checkpoints/deca/deca_model.tar` | DECA 推論 | [DECA repo](https://github.com/yfeng95/DECA) |
...
| `checkpoints/flame/generic_model.pkl` | FLAME メッシュ可視化 | [FLAME website](https://flame.is.tue.mpg.de/) |
